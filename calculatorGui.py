...
btn_log=Button(root,text='logn',bg='#00a65a',fg='white',width=5,height=2)
btn_log.grid(row=5,column=0)
btn_log.config(font=('verdana',14))

btn_power=Button(root,text='x^n',bg='#00a65a',fg='white',width=5,height=2)
btn_power.grid(row=5,column=1)
btn_power.config(font=('verdana',14))

btn_sqrt=Button(root,text='sqrt',bg='#00a65a',fg='white',width=5,height=2)
btn_sqrt.grid(row=5,column=2)
btn_sqrt.config(font=('verdana',14))

btn_perm=Button(root,text='perm',bg='#00a65a',fg='white',width=5,height=2)
btn_perm.grid(row=5,column=3)
btn_perm.config(font=('verdana',14))
